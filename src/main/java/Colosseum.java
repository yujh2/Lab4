...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        do {
            ...
            if (tempPokemon.attackLevel < 0 || tempPokemon.attackLevel > MAX_HIT_POINTS - 1) {
        ...
        int newMax = (MAX_HIT_POINTS - tempPokemon.attackLevel);
        do {
            System.out.println("Enter your defense level (1-" + newMax + "): ");
            tempPokemon.defenseLevel = sc.nextInt();
            if (tempPokemon.defenseLevel < 0 || tempPokemon.defenseLevel > newMax) {
                System.out.println("Sorry. Defense Level must be between 1 and " + newMax + ".");
            }
        } while (tempPokemon.defenseLevel < 0 || tempPokemon.defenseLevel > newMax);
        return tempPokemon;
    }
